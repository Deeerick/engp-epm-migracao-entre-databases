...
SELECT
    ...
    CASE
        ...
        AND CHARINDEX('MREL', medida_TEXTO_STATUS_SISTEMA + ' ' + medida_TEXTO_STATUS_USUARIO) = 0
        AND CHARINDEX('CANC', medida_TEXTO_STATUS_SISTEMA + ' ' + medida_TEXTO_STATUS_USUARIO) = 0
        AND CHARINDEX('ELIM', medida_TEXTO_STATUS_SISTEMA + ' ' + medida_TEXTO_STATUS_USUARIO) = 0 THEN 1
        ELSE 0
    END AS QUIT,
    CASE
        WHEN CHARINDEX('CANC', medida_TEXTO_STATUS_SISTEMA + ' ' + medida_TEXTO_STATUS_USUARIO) > 0
        OR CHARINDEX('ELIM', medida_TEXTO_STATUS_SISTEMA + ' ' + medida_TEXTO_STATUS_USUARIO) > 0
        OR CHARINDEX('MREL', medida_TEXTO_STATUS_SISTEMA + ' ' + medida_TEXTO_STATUS_USUARIO) > 0 THEN 1
        ELSE 0
    END AS CANC,
    CASE
